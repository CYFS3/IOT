...
#define READ_SDA   GPIO_ReadInBit(HT_GPIOA,GPIO_PIN_1)  
...
void AT24CXX_Init(void)
{
	...
	//配置端口功能为GPIO
	AFIO_GPxConfig(GPIO_PA, GPIO_PIN_0, AFIO_FUN_GPIO);  //scl
	AFIO_GPxConfig(GPIO_PA, GPIO_PIN_1, AFIO_FUN_GPIO);  //sda
