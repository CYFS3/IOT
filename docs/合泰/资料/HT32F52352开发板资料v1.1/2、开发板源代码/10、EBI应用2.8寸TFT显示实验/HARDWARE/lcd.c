...
{ 			
  ...
  AFIO_GPxConfig(GPIO_PA, AFIO_PIN_11, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PC, AFIO_PIN_1, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PC, AFIO_PIN_2, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PC, AFIO_PIN_3, AFIO_FUN_EBI);

  AFIO_GPxConfig(GPIO_PA, AFIO_PIN_14, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PA, AFIO_PIN_15, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PB, AFIO_PIN_0, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PB, AFIO_PIN_1, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PB, AFIO_PIN_2, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PB, AFIO_PIN_3, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PB, AFIO_PIN_4, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PB, AFIO_PIN_5, AFIO_FUN_EBI);

  AFIO_GPxConfig(GPIO_PC, AFIO_PIN_14, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PC, AFIO_PIN_15, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PD, AFIO_PIN_1, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PD, AFIO_PIN_2, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PD, AFIO_PIN_3, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PC, AFIO_PIN_10, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PC, AFIO_PIN_11, AFIO_FUN_EBI);
  AFIO_GPxConfig(GPIO_PC, AFIO_PIN_12, AFIO_FUN_EBI);

  //背光
  AFIO_GPxConfig(GPIO_PB, GPIO_PIN_7, AFIO_FUN_GPIO);
  ...
  EBI_InitStructure.EBI_IdleCycleTime = 5;
  EBI_InitStructure.EBI_AddressSetupTime = 5;
  EBI_InitStructure.EBI_AddressHoldTime = 5;
  EBI_InitStructure.EBI_WriteSetupTime = 5;
  EBI_InitStructure.EBI_WriteStrobeTime = 5;
  EBI_InitStructure.EBI_WriteHoldTime = 5;
  EBI_InitStructure.EBI_ReadSetupTime = 5;
  EBI_InitStructure.EBI_ReadStrobeTime = 5;
  EBI_InitStructure.EBI_ReadHoldTime = 5;
...
void LCD_DispPicture(u16 x,u16 y,u16 width,u16 height,u16 *p)
{
	  u32 i, num;
