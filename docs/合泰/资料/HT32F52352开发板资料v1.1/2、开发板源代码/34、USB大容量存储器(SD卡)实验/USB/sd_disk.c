...
u32 SDDISK_Read(u32 uId, u8 **pBuffer, u32 uBlockAddress, u32 uLength)
{
  ...
  if (uId == SDDISK0_ID)
  {
    if ((uBlockAddress / CACHE_CNT != uCachePage / CACHE_CNT) && (uCachePage != uBlockAddress))
    {
      ...
      SD_ReadDisk(guReadBuffer, uBlockAddress, (u8)(SDISK_READ_BUFFER/512));
    }
...
u32 SDDISK_Write(u32 uId, u8 *pBuffer, u32 uBlockAddress, u32 uLength)
{
  ...
  if (uId == SDDISK0_ID)
  {
    ...
    if (guWriteBufferOffset == SDDISK0_BlockSize)
    {
      ...
      SD_WriteDisk(guWriteBuffer, uBlockAddress, SDDISK0_BlockSize/512);
    }
  }
  else
  {
  ...
  else
  {
    ...
    else
    {
      ...
      if (SD_Type == SD_TYPE_V2HC)
      {
        ...
        pSizeInfo->uBlockCount = (u32)(SDCSD.DeviceSize + 1) * 512 * 2;
      }
      else
      #endif
      {
        ...
        pSizeInfo->uBlockCount = (u32)(SDCSD.DeviceSize + 1) * uSizeMul;
      }
    }
  }
