...
int main(void)
{
	...
	while(1)
	{		
		dispbmp((u8*)"0:/BMP/扫描二维码进店看看.bmp",0,0,240,320);
		Show_Str(0,0,240,16,(u8*)"扫描二维码进店看看.bmp",16,1);
		delay_ms(5000);
		
		LCD_Clear(WHITE);
		dispbmp((u8*)"0:/BMP/EASEAR.bmp",0,100,240,97);
		Show_Str(0,0,240,16,(u8*)"EASEAR.bmp",16,1);
		delay_ms(3000);
		dispbmp((u8*)"0:/BMP/动漫1.bmp",0,0,240,320);
		Show_Str(0,0,240,16,(u8*)"动漫1.bmp",16,1);
		delay_ms(3000);
		dispbmp((u8*)"0:/BMP/动漫2.bmp",0,0,240,320);
		Show_Str(0,0,240,16,(u8*)"动漫2.bmp",16,1);
		delay_ms(3000);
		dispbmp((u8*)"0:/BMP/动漫3.bmp",0,0,240,320);
		Show_Str(0,0,240,16,(u8*)"动漫3.bmp",16,1);
		delay_ms(3000);
		dispbmp((u8*)"0:/BMP/动漫4.bmp",0,0,240,320);
		Show_Str(0,0,240,16,(u8*)"动漫4.bmp",16,1);
		delay_ms(3000);		
